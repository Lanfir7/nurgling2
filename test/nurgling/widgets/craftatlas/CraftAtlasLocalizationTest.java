...
class CraftAtlasLocalizationTest {
    ...
    private static void assertComplete(Properties properties) {
        ...
        required.addAll(Arrays.asList(
                ...
                "craft_atlas.table.gilding_slots", "craft_atlas.table.gilding_slots_tip",
                "craft_atlas.table.gilding_attributes", "craft_atlas.table.gilding_attributes_tip",
                "craft_atlas.table.gilding_chance", "craft_atlas.table.gilding_chance_tip",
