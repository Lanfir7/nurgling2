...
public class DatabaseSettings extends Panel {
    ...
    public DatabaseSettings() {
        ...
        reconnectStatus = add(new Label(""), new Coord(labelX + UI.scale(210), y + UI.scale(6)));
        y += reconnectBtn.sz.y + UI.scale(10);
    ...
    /** Persist the form without reconnecting — used by save() and the Reconnect button. */
