...
public class WaypointStepsWindow extends Window {
    ...
    private static final String[] FAIL_ACTIONS = ForagerWaypoint.FAIL_ACTIONS;
    ...
    public WaypointStepsWindow(ForagerWaypoint waypoint, Runnable onChanged) {
        ...
        Dropbox<String> failDropbox = add(new Dropbox<String>(UI.scale(150), FAIL_ACTIONS.length, UI.scale(16)) {
            ...
            public void change(String item) {
                super.change(item);
                waypoint.onStepsFailAction = ForagerWaypoint.normalizeOnStepsFailAction(item);
                if (!initializing) {
                    fireChanged();
                }
            }
        ...
        String current = ForagerWaypoint.normalizeOnStepsFailAction(waypoint.onStepsFailAction);
