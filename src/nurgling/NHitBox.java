...
//            put("gfx/terobjs/fineryforge", new NHitBox(new Coord(-9,-9),new Coord(9,9)));
            ...
            put("gfx/terobjs/timbertunnel", new NHitBox(new Coord2d(0,0),new Coord2d(0,0), true));
            put("gfx/terobjs/reinforcedtunnel", new NHitBox(new Coord2d(0,0),new Coord2d(0,0), true));
            put("gfx/terobjs/stonearchtunnel", new NHitBox(new Coord2d(0,0),new Coord2d(0,0), true));
            ...
            put("gfx/terobjs/bpyre", new NHitBox(new Coord(-5,-5),new Coord(5,5)));
            put("gfx/terobjs/minepyre", new NHitBox(new Coord(-11,-11),new Coord(11,11)));
            ...
            put("gfx/terobjs/stockpile-wildfibre", new NHitBox(new Coord2d(-3,-3),new Coord2d(3,3), true));
