...
public class UnloadAnimalsAction implements GobContextAction {
    ...
    @Override
    public String label() {
        return nurgling.i18n.L10n.get("context.unload_animals");
    }

    @Override
    public Action create(Gob vehicle) {
        return gui -> {
            NArea dest = NContext.findSpec("deadkritter");
            if (dest == null)
