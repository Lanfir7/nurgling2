...
public final class SpiceCalc {
    ...
    public static Result apply(List<FepValue> feps, double hunger, Map<Spice, Double> qualities) {
        List<FepValue> cur = new ArrayList<>(feps == null ? Collections.<FepValue>emptyList() : feps);
        double h = hunger;
        Map<Spice, Double> qs = (qualities == null) ? Collections.<Spice, Double>emptyMap() : qualities;
