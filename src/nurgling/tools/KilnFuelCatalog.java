...
public final class KilnFuelCatalog {
    public static final class Entry {
        ...
        Entry(String item, String realTime, String inGameTime, int fuelUnits, String notes) {
            this.item = item;
    ...
    private static final List<Entry> ENTRIES = Collections.unmodifiableList(Arrays.asList(
            ...
            new Entry("Branding Iron", "0:04:33", "0:14:58", 1, "warm up"),
            new Entry("Brick", "0:08:58", "0:29:30", 2, "Coade Clay excluded"),
