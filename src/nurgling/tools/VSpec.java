...
public class VSpec {
    ...
    static {
        ...
        oldtrunkOp.add(HarvestState.getBarkProductName("gfx/terobjs/trees/oldtrunk"));
...
//        stones.add(new JSONObject("{\"static\":\"gfx/invobjs/korundstone\",\"name\":\"Korund Stone\"}"));
        ...
        seedsAndBerries.add(new JSONObject("{\"static\":\"gfx/invobjs/seed-crabappletree\",\"name\":\"Crabapples\"}"));
    ...
    /** Every gob resource path known to produce the given item name, per object; empty if none. */
