            ...
            if (drawable.getres().getLayers() != null)
            {
                ...
                if (name != null)
                {
                    ...
                    if (NParser.checkName(name, MINEBEAM_ALIAS))
                        ...
                        } else if (name.equals("gfx/terobjs/beehive"))
                        {
                            try {
                                parent.setattr(new nurgling.gattrr.NBeehiveColor(parent));
                            } catch (Exception e) {
                                System.err.println("Failed to create NBeehiveColor: " + e.getMessage());
                            }
    ...
    public void tick(double dt)
    {
        if (NUtils.getGameUI() != null)
        {
            ...
            if (hash == null)
            {
                ...
                if (gui != null && gui.ui != null && gui.ui.sess != null && gui.ui.sess.glob != null && gui.ui.sess.glob.map != null)
                {
