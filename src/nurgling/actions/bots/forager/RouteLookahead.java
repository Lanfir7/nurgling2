...
public class RouteLookahead {
    ...
    /** True if a later stop beats the current anchor by the safety margin. */
    static boolean isClearlyCloser(Coord2d anchor, Coord2d laterStop, Coord2d gob) {
        return anchor != null && laterStop != null && gob != null
                && laterStop.dist(gob) + MARGIN < anchor.dist(gob);
    }
    ...
    public boolean leaveForLaterStop(Gob gob, MCache map, MiniMap.Location sessloc, boolean waterMode) {
        if (anchor == null || gob == null) return false;
        ...
        boolean later = isClearlyCloser(anchor, best, gob.rc)
