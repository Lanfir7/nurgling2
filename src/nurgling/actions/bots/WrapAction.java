...
public class WrapAction implements Action {
    ...
    public Results run(NGameUI gui) throws InterruptedException {
        ...
        if (new Validator(req, opt).fuel(Specialisation.SpecName.fuelKiln, "branch").run(gui).IsSuccess()) {
            ...
            while (res == null || res.IsSuccess()) {
                ...
                res = new FillContainersFromPiles(containers, pile_area, wraps).run(gui);
