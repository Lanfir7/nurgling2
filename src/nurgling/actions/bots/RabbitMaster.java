...
public class RabbitMaster implements Action {
    ...
    public Results run(NGameUI gui) throws InterruptedException {
        ...
        fillConfiguredFluids(gui, containers, swillArea, waterArea);
    ...
    void fillConfiguredFluids(NGameUI gui, ArrayList<Container> containers,
                              NArea swillArea, NArea waterArea) throws InterruptedException {
        if (swillArea != null) {
