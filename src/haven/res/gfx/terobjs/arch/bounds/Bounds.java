...
@haven.FromResource(name = "gfx/terobjs/arch/bounds", version = 1, override = true)
public class Bounds {
     ...
     * the survey plot stakes in the air.
     */
	...
	return(new Coord3f(rx, -ry, poleLocalZ(FlatWorld.isEnabled(), map.getcz(rx + cc.x, ry + cc.y), cc.z)));
    }
	...
	public void autotick(double dt) {
	    ...
	    if((curseq == this.mapseq) && (flat == lastFlat))
		return;
	    try {
