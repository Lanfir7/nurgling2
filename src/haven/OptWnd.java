...
public class OptWnd extends Window {
	...
	public BindingPanel(Panel back) {
		...
		y = addbtn(cont, "Switch to Session 1", nurgling.sessions.SessionTabBar.kb_session1, y);
		y = addbtn(cont, "Switch to Session 2", nurgling.sessions.SessionTabBar.kb_session2, y);
		y = addbtn(cont, "Switch to Session 3", nurgling.sessions.SessionTabBar.kb_session3, y);
		y = addbtn(cont, "Switch to Session 4", nurgling.sessions.SessionTabBar.kb_session4, y);
		y = addbtn(cont, "Switch to Session 5", nurgling.sessions.SessionTabBar.kb_session5, y);
		y = addbtn(cont, "Switch to Session 6", nurgling.sessions.SessionTabBar.kb_session6, y);
		y = addbtn(cont, "Switch to Session 7", nurgling.sessions.SessionTabBar.kb_session7, y);
		y = addbtn(cont, "Switch to Session 8", nurgling.sessions.SessionTabBar.kb_session8, y);
		y = addbtn(cont, "Switch to Session 9", nurgling.sessions.SessionTabBar.kb_session9, y);
